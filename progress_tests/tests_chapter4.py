...
class Chapter4IndexPageTests(TestCase):
    ...
    def test_index_starts_with_doctype(self):
        ...
        self.assertTrue(
            ...
            or content.startswith("<!doctype html>"),  # allow prettier to run
    ...
    def test_about_link_present(self):
        ...
        self.assertTrue(
            expected in self.response.content.decode(),
...
class Chapter4StaticMediaTests(TestCase):
    ...
    def test_context_processor_addition(self):
        ...
        self.assertTrue(
            "django.template.context_processors.media" in context_processors_list,
...
class Chapter4ExerciseTests(TestCase):
    ...
    def test_about_starts_with_doctype(self):
        ...
        """
        content = self.about_response.content.decode()
    ...
    def test_about_contains_required_text(self):
        ...
        for required_str in required:
            self.assertTrue(
                required_str in self.about_response.content.decode(),
    ...
    def test_about_contains_cat(self):
        ...
        """
        required_pattern = (
            f'<img src="{settings.MEDIA_URL}cat.jpg" alt="Picture of a Cat.?" />'
        )

        self.assertTrue(
            re.search(required_pattern, self.about_response.content.decode()),
